class MoviesController < ApplicationController
  ...
  def show
    @movie = 
      Movie.where(:youtube_id => params[:id]).first ||
  ...
  # find a list of movies that match certain queries
  def index
  ...
  def movie_params
    params.require(:movie)
      .permit(:title, :youtube_id, :poster_url, :released, :rated, :running_time, :description)
  end
end